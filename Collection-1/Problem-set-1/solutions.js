...
// console.log(areAllCharUnique("qwer"));
// console.log(areAllCharUnique("desktop"));
// console.log(areAllCharUnique("qwerqwer"));
...
// console.log(capitalizeWords("Always remember that you are absolutely unique."));
// console.log(capitalizeWords("You have brains in your head."));
